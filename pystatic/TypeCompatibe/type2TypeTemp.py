...
from pystatic.typesys import TypeIns, TypeTemp, TypeOptionalTemp, TypeTupleTemp, TypeClassTemp,TypeListTemp,TypeLiteralIns
class Literal2Type:
    def __init__(self):
        self.dict={'int':TypeTemp('int',builtins),
